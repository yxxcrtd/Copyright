...
<body>
	<div id="sidebar">
		<div id="sidebar-collapse" onclick="corpSpace.hideTree()">
		...
		<div id="sidebar-shortcuts">
			...
			<div id="rMenu">
				<ul>
					<li id="add" onclick="corpSpace.addNode()" onmouseover="this.style.backgroundColor='#b6bdd2';" onmouseout="this.style.backgroundColor='';">创建${form.corpType.name}</li>
					<li id="edit" onclick="corpSpace.editNode()" onmouseover="this.style.backgroundColor='#b6bdd2';" onmouseout="this.style.backgroundColor='';">修改${form.corpType.name}</li>
					<li id="delete" onclick="corpSpace.removeNode()" onmouseover="this.style.backgroundColor='#b6bdd2';" onmouseout="this.style.backgroundColor='';">删除${form.corpType.name}</li>
					<li id="upload" onclick="corpSpace.upload()" onmouseover="this.style.backgroundColor='#b6bdd2';" onmouseout="this.style.backgroundColor='';">上传</li> 
				</ul>
			</div>
		</div>
	</div>
					...
					<div class="row-fluid">
						...
						<div class="row-fluid">
							...
							<form:form id="crmCorpForm" commandName="form" class="form-horizontal">
								...
								<form:hidden path="relation.parentRelationship.id" id="relation_parent_id" />
								...
								<div class="row-fluid">
									<div class="control-group span4" id="corp_code_div">
										<label class="control-label" for="form-field-1"><font class="red">*</font>编码：</label>
										<div class="controls">
											<form:input path="corp.code" id="corp_code" class="span10" onfocus="corpSpace.codeFocusFn()" onblur="corpSpace.validate_code()" />
											<span id="corp_code_span" class="help-inline"></span>
										</div>
									</div>
									
									<div class="control-group span4" id="corp_shortName_div">
										<label class="control-label" for="form-field-1"><font class="red">*</font>简称：</label>
										<div class="controls">
											<form:input path="corp.shortName" id="corp_shortName" class="span10" onblur="corpSpace.validate_shortName()" />
								...
								<div class="row-fluid">
									<div class="control-group span4" id="corp_nameFirstChar_div">
										<label class="control-label" for="form-field-1">快捷搜索拼音：</label>
										<div class="controls">
											<form:input path="corp.nameFirstChar" id="corp_nameFirstChar" class="span10" />
											<span id="corp_nameFirstChar_span" class="help-inline"></span>
										</div>
									</div>
								...
								<div class="form-actions"
									...
									&nbsp; &nbsp; &nbsp;
									<button class="btn btn-inverse" id="reset" type="reset">
