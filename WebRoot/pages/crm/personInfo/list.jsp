			...
			<div class="row-fluid">
				...
				<div class="row-fluid">
					...
					<div class="ace-thumbnails">
						<button class="btn btn-small btn-primary" type="button" onclick="Editorial.CRM.PersonInfo.addObj();">
							<i class="icon-plus-sign bigger-125"></i> 新建${form.personType.name}信息
						</button>
						<button class="btn btn-small btn-primary" type="button" onclick="Editorial.CRM.PersonInfo.uploadObj();">
