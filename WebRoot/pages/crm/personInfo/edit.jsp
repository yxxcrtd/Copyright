								...
								<div class="control-group span6 ">
									...
									<div class="row-fluid ">
										<div id="codeDiv" class="control-group">
											<label class="control-label" for="form-field-2"><span class='red'>*</span>${form.personType.name}编号：</label>
											<div class="controls">
									...
									<div class="row-fluid">
											<div id="corpDiv" class="control-group zTreeDemoBackground left">
												<label class="control-label" for="form-field-1"> <span class='red'>*</span>公司名称：</label>
												<div class="controls">
											...
											<div id="menuContent" class="menuContent" style="display: none; position: absolute; z-index: 999999;">
												<ul id="treeManage" class="ztree" style="margin-top: 10px; border: 1px solid #617775; background: #f0f6e4; width: 300px; height: 160px; overflow-y: scroll; overflow-x: auto;"></ul>
											</div>
									</div>
									<div class="row-fluid ">
									...
									<div class="row-fluid ">
										<div id="emailDiv" class="control-group">
											<label class="control-label" for="form-field-1"> <span class='red'>*</span>电子邮箱：</label>
											<div class="controls">
												<form:input path="obj.email" id="email" placeholder="电子邮箱" class="span8" onblur="Editorial.CRM.PersonInfo.validateEmailLength();"/>
								...
								<div class="control-group span6 ">
									...
									<div class="row-fluid ">
										<div id="nameDiv" class="control-group">
											<label class="control-label" for="form-field-1"><span class='red'>*</span> ${form.personType.name}姓名：</label>
											<div class="controls">
												<form:input path="obj.name" id="name" placeholder="员工姓名" onblur="Editorial.CRM.PersonInfo.validateName();" class="span8" />
