				...
				<div class="row-fluid">
					...
					<form:form id="editSysAccontForm" commandName="form" class="form-horizontal">
						...
						<div id="nameDiv" class="control-group ">
							<label class="control-label" for="form-field-2"><font class="red">*</font>账户名称：</label>
							<div class="controls">
						...
						<div id="passDiv" class="control-group ">
							<label class="control-label" for="form-field-1"><font class="red">*</font>账户密码：</label>
							<div class="controls">
								<form:password path="account.pass" id="pass" placeholder="账户密码" onblur="Editorial.CRM.PersonInfo.SysAccount.validatePass();" class="span6" />
						...
						<div id="statusDiv" class="control-group ">
							<label class="control-label" for="form-field-1"><font class="red">*</font>用户状态：</label>
							<div class="controls">
								<form:select path="account.status" id="status" class="span6" onblur="Editorial.CRM.PersonInfo.SysAccount.validateStatus();">
						...
						<div id="encryptionDiv" class="control-group ">
							<label class="control-label" for="form-field-1"><font class="red">*</font>加密：</label>
							<div class="controls">
								<form:select path="account.encryption" id="encryption" class="span6" onblur="Editorial.CRM.PersonInfo.SysAccount.validateEncryption();">
                                    <form:option value="">-选择-</form:option>
									<c:forEach items="${form.encryptionMap}" var="t">
										<form:option value="${t.key}">${t.value}</form:option>
									</c:forEach>
								</form:select>
								<span id="encryptionSpan" class="help-inline"></span>
							</div>
						</div>
						<form:hidden path="id" />
