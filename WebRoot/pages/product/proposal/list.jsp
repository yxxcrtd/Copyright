        ...
        <div class="row-fluid">
            ...
            <div class="page-header position-relative">
                <h1>
                    策划创意管理
                    <small>
                        <i class="icon-double-angle-right"></i> 策划创意管理列表
                    </small>
                </h1>
            </div>
            <!-- ------------------导航页面部分结束----------------------------- -->
            <div class="row-fluid">
                ...
                <div class="ace-thumbnails">
                    <button class="btn btn-small btn-primary" onclick="Editorial.Proposal.editObj('');">
                        <i class="icon-plus-sign bigger-125"></i> 新建策划创意
                    </button>
                </div>
                <!-- ------------------功能按钮结束----------------------------- -->
                        ...
                        <div class="row-fluid">
                            ...
                            <div style="text-align: center;">
                                <button class="btn btn-small btn-success" type="button"
                                        onclick="Editorial.Proposal.query();">
                ...
                <!-- ------------------功能页面部分结束----------------------------- -->
                <!-- ------------------列表页面部分开始----------------------------- -->
                <div class="table-header"><i class="icon-flag"></i>&nbsp;&nbsp;策划创意列表</div>
