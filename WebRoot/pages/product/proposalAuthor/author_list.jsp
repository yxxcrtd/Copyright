...
<script src="${ctx}/pages/product/proposalAuthor/author_list.js"></script>
</head>
<body>
	<div class="clearfix">
						...
						<form:form id="form" commandName="form" action="manager" class="form-horizontal">
							<div class="row-fluid">
								...
								<div style="text-align: center;">
									<button class="btn btn-small btn-success" type="button" onclick="Editorial.Person.Author.query();">
