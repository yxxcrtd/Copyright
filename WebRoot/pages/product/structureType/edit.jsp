			...
			<div class="row-fluid">
				...
				<div class="row-fluid">
					...
					<div class="control-group" id="structureType_name_div">
							<label class="control-label" for="form-field-1">素材类型名称：</label>
							<div class="controls">
								<form:input path="structureType.name" id="structureType_name" onblur="Editorial.CRM.CorpType.typeName()" placeholder="素材类型名称" class="span6" />
								<span id="structureType_name_span" class="help-inline"></span>
							</div>
						</div>

						<div class="control-group" id="structureType_code_div">
							<label class="control-label" for="form-field-1">素材类型编号：</label>
							<div class="controls">
								<form:input path="structureType.code" id="structureType_code" onblur="Editorial.CRM.CorpType.code()" placeholder="素材类型编号" class="span6" />
