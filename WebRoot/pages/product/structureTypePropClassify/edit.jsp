				...
				<div class="page-header position-relative">
					<h1>素材类型属性分类管理
						<small><i class="icon-double-angle-right"></i>
							<c:choose>
								<c:when test="${form.structureTypePropClassify.id == null}">新建</c:when>
				...
				<div class="row-fluid">
					...
					<form:form id="structureTypePropClassifyForm" commandName="form" class="form-horizontal">
						...
						<div class="control-group" id="structureTypePropClassify_name_div">
							<label class="control-label" for="form-field-1">素材分类名称：</label>
							<div class="controls">
								<form:input path="structureTypePropClassify.name" id="structureTypePropClassify_name" placeholder="素材分类名称" class="span6" />
						...
						<div class="control-group" id="structureTypePropClassify_code_div">
							<label class="control-label" for="form-field-1">素材分类编码：</label>
							<div class="controls">
								<form:input path="structureTypePropClassify.code" id="structureTypePropClassify_code" placeholder="素材分类编码" class="span6" />
						...
						<div class="control-group" id="structureTypePropClassify_order_div">
							<label class="control-label" for="form-field-1">素材分类排序：</label>
							<div class="controls">
								<form:input path="structureTypePropClassify.order" id="structureTypePropClassify_order" placeholder="素材分类排序" class="span6" />
