					...
					<form:form id="crRightForm" commandName="form" class="form-horizontal">
						...
						<div class="on-down" id="on_down">
							<div class="row-fluid ">
								...
								<div class="control-group span4" id="crRight_proposal_id_div">
									<label class="control-label" for="form-field-1">策划：</label>
									<div class="controls">
										<form:select path="crRight.proposal.id" id="proposal_id" cssClass="span6">
											<form:option value="">--选择--</form:option>
											<c:forEach items="${form.proposalList}" var="prp">
                                                <form:option value="${prp.id}">${prp.name}</form:option>
                                            </c:forEach>
										</form:select>
										<span id="crRight_proposal_id_span" class="help-inline"></span>
									</div>
								</div>
								...
								<div class="control-group span4" id="licenseType_id_div">
									...
									<div class="controls">
										<form:select path="crRight.licenseType.licenseTypeId" id="licenseType_id" cssClass="span6" onblur="Editorial.CrRight.validate_licenseType()">
											<form:option value="">--选择--</form:option>
								...
								<div class="control-group span4" id="crRight_paymentTrem_div">
									<label class="control-label" for="form-field-1" title="付款日期">版税付款条款：</label>
									<div class="controls">
									<form:input path="crRight.paymentTrem" id="crRight_paymentTrem" cssClass="span6" onblur="Editorial.CrRight.validate_paymentTrem()" onkeypress="onlyInputIntegerNumber(event, this)" placeholder="版税付款条款" />天
								...
								<div class="control-group span4" id="crRight_rcexclusive_div">
									...
									<div class="controls">
										<form:select path="crRight.rcexclusive" id="crRight_rcexclusive" cssClass="span6" onblur="Editorial.CrRight.validate_rcexclusive()">
											<form:option value="">--选择--</form:option>
								...
								<div class="control-group span4" id="crRight_rlicenseName_div">
									...
									<div class="controls">
									<form:input path="crRight.rlicenseName" id="crRight_rlicenseName" cssClass="span6" onblur="Editorial.CrRight.validate_rlicenseName()" placeholder="授权名称" />
								...
								<div class="control-group span4" id="crRight_rlperiod_div">
									...
									<div class="controls">
										<form:select path="crRight.rlperiod" id="crRight_rlperiod" cssClass="span6" onblur="Editorial.CrRight.validate_rlperiod()">
											<form:option value="">--选择--</form:option>
								...
								<div class="control-group span4" id="crRight_contract_id_div">
									...
									<div class="controls">
										<form:select path="crRight.contract.contractId" id="contract_id" cssClass="span6">
											<form:option value="">--选择--</form:option>
								...
								<div class="control-group span4" id="crRight_status_div">
									...
									<div class="controls">
										<form:select path="crRight.status" id="crRight_status" cssClass="span6" onblur="Editorial.CrRight.validate_status()">
											<form:option value="">--选择--</form:option>
								...
								<div class="control-group span12" id="crRight_rlicenseReference_div">
									...
									<div class="controls">
										<form:textarea path="crRight.rlicenseReference" id="crRight_rlicenseReference" cssClass="span6 h50" placeholder="授权说明" />
				        ...
				        <div class="tab-content">
				            ...
				            <div class="tab-pane active" id="contractDetails">
				            	<div class="control-group span4" id="crRight_rlicenseStarton_div">
									...
									<div class="controls">
										<div id="crRight_rlicenseStarton_Date_Control" class="input-append">
											<input type="text" name="crRight.rlicenseStarton" class="span10" value="<fmt:formatDate value="${form.crRight.rlicenseStarton}" pattern="yyyy-MM-dd" />" id="crRight_rlicenseStarton" onblur="Editorial.CrRight.validate_rlicenseStarton()" placeholder="授权开始时间" data-format="yyyy-MM-dd" />
								...
								<div class="control-group span4" id="crRight_rlicenseEndon_div">
									...
									<div class="controls">
										<div id="crRight_rlicenseEndon_Date_Control" class="input-append">
											<input type="text" name="crRight.rlicenseEndon" class="span10" value="<fmt:formatDate value="${form.crRight.rlicenseEndon}" pattern="yyyy-MM-dd" />" id="crRight_rlicenseEndon" onblur="Editorial.CrRight.validate_rlicenseEndon()" placeholder="授权结束时间" data-format="yyyy-MM-dd" />
											<span class="add-on"> <i data-time-icon="icon-time" data-date-icon="icon-calendar" > </i></span>
										</div>
								...
								<div class="control-group span4" id="crRight_start_div">
									...
									<div class="controls">
										<form:select path="crRight.start" id="crRight_start" cssClass="span6" onblur="Editorial.CrRight.validate_start()">
											<form:option value="">--选择--</form:option>
								...
								<div class="control-group span4" id="crRight_manuscriptDelivery_div">
									...
									<div class="controls">
										<div id="crRight_manuscriptDelivery_Date_Control" class="input-append">
											<input type="text" name="crRight.manuscriptDelivery" class="span10" value="<fmt:formatDate value="${form.crRight.manuscriptDelivery}" pattern="yyyy-MM-dd" />" id="crRight_manuscriptDelivery" placeholder="书稿提交日期" data-format="yyyy-MM-dd" />
											<span class="add-on"> <i data-time-icon="icon-time" data-date-icon="icon-calendar" > </i></span>
										</div>
								...
								<div class="control-group span4" id="crRight_pubDeadline_div">
									<label class="control-label" for="form-field-1" title="出版截至期限">出版截至条款：</label>
									<div class="controls">
								...
								<div class="control-group span4" id="crRight_owerCopy_div">
									<label class="control-label" for="form-field-1" title="作者副本数">作者副本量：</label>
									<div class="controls">
								...
								<div class="control-group span4" id="crRight_agentCopy_div">
									<label class="control-label" for="form-field-1" title="代理商副本数">代理副本量：</label>
									<div class="controls">
								...
								<div class="control-group span4" id="crRight_lastedDate_div">
									...
									<div class="controls">
										<div id="crRight_lastedDate_Date_Control" class="input-append">
											<input type="text" name="crRight.lastedDate" class="span10" value="<fmt:formatDate value="${form.crRight.lastedDate}" pattern="yyyy-MM-dd" />" id="crRight_lastedDate" placeholder="最近报告日期" data-format="yyyy-MM-dd" />
											<span class="add-on"> <i data-time-icon="icon-time" data-date-icon="icon-calendar" > </i></span>
										</div>
								...
								<div class="control-group span4" id="crRight_firstCloseDate_div">
									...
									<div class="controls">
										<div id="crRight_firstCloseDate_Date_Control" class="input-append">
											<input type="text" name="crRight.firstCloseDate" class="span10" value="<fmt:formatDate value="${form.crRight.firstCloseDate}" pattern="yyyy-MM-dd" />" id="crRight_firstCloseDate" placeholder="首次结算报告日期" data-format="yyyy-MM-dd" />
											<span class="add-on"> <i data-time-icon="icon-time" data-date-icon="icon-calendar" > </i></span>
										</div>
				            ...
				            <!-- authorizedArea 开始 -->
				            <div class="tab-pane" id="authorizedArea">
				            	<div class="row-fluid">
									<!-- 功能按钮开始 -->
									<div class="ace-thumbnails">
										<button class="btn btn-small btn-primary" type="button" onclick="Editorial.CrRight.selectCountry()">
											<i class="icon-plus-sign bigger-125"></i> 选择
										</button>
										
										<button class="btn btn-small btn-primary" type="button" onclick="Editorial.CrRight.removeCountry()">
									...
									<div class="on-down" id="on_down">
										<div class="row-fluid">
											...
											<div style="text-align: center;">
												<button class="btn btn-small btn-success" type="button" onclick="Editorial.CrRight.queryCountry()">
				            ...
				            <div class="tab-pane" id="authorizationLanguage">
				            	<div class="row-fluid">
									<!-- 功能按钮开始 -->
									<div class="ace-thumbnails">
										<button class="btn btn-small btn-primary" type="button" onclick="Editorial.CrRight.selectLanguage()">
											<i class="icon-plus-sign bigger-125"></i> 选择
										</button>
										
										<button class="btn btn-small btn-primary" type="button" onclick="Editorial.CrRight.removeLanguage()">
											<i class="icon-plus-sign bigger-125"></i> 删除
										</button>
									</div>
									<!-- 功能按钮结束 -->
									...
									<div class="on-down" id="on_down">
										<div class="row-fluid">
											...
											<!-- 查询按钮开始 -->
											<div style="text-align: center;">
												<button class="btn btn-small btn-success" type="button" onclick="Editorial.CrRight.queryLanguage()">
													<i class="icon-zoom-in bigger-110"></i>查询
												</button>
												&nbsp;&nbsp;
												<button type="reset" class="btn btn-small btn-inverse">
				            	...
				            	<div class="row-fluid">
									...
									<div class="on-down" id="on_down">
										<div class="row-fluid">
											...
											<!-- 查询按钮开始 -->
											<div style="text-align: center;">
												<button class="btn btn-small btn-success" type="button" onclick="Editorial.CrRight.queryProducts();">
													<i class="icon-zoom-in bigger-110"></i>查询
												</button>
												&nbsp;&nbsp;
												<button type="reset" class="btn btn-small btn-inverse">
				            ...
				            <!-- signingContributor 开始 -->
				            <div class="tab-pane" id="signingContributor">
				            	<div class="row-fluid">
									<!-- 功能按钮开始 -->
									<div class="ace-thumbnails">
										<button class="btn btn-small btn-primary" type="button" onclick="Editorial.CrRight.editSigningContributor()">
											<i class="icon-plus-sign bigger-125"></i> 新建签约贡献者信息
										</button>
									</div>
									<!-- 功能按钮结束 -->
									<div class="table-header on" id="on">
										...
										<div class="row-fluid">
											...
											<div class="row-fluid">
												...
												<div class="control-group span3">
													...
													<div class="controls">
														<input type="text" id="owner_person_name" placeholder="姓名" />
													</div>
												</div>
											...
											<!-- 查询按钮开始 -->
											<div style="text-align: center;">
												<button class="btn btn-small btn-success" type="button" onclick="Editorial.CrRight.queryContributor();">
													<i class="icon-zoom-in bigger-110"></i>查询
												</button>
												&nbsp;&nbsp;
												<button type="reset" class="btn btn-small btn-inverse">
									...
									<!-- 列表部分开始 -->
									<div class="table-header">
										<i class="icon-flag"></i>&nbsp;&nbsp;签约贡献者信息列表
									</div>
									<table id="signingContributorDataTable" class="table table-striped table-bordered table-hover">
										<thead>
											<tr>
												<th width="10%" align="center"></th>
												<th width="10%" align="center"></th>
				            ...
				            <!-- signingContributor 结束 -->
				            
				            <!-- subsidiaryRights 开始 -->
				            <div class="tab-pane" id="subsidiaryRights">
				            
				<div class="row-fluid">
					<!---------------功能页面部分开始 --------------------->
					<!---------------功能按钮部分开始 --------------------->
					<div class="ace-thumbnails">
						<button class="btn btn-small btn-primary" type="button" onclick="Editorial.CrRight.editSubsidiaryRights()">
							<i class="icon-plus-sign bigger-125"></i> 新建版税附属版权
						</button>
					</div>
					<!---------------功能按钮部分开始 --------------------->
					<!-- ------------------查询开始----------------------------- -->
                    ...
                    <div class="on-down">
                            <div class="row-fluid">
                                <div class="control-group span3">
                                    ...
                                    <div class="controls">
                                        <form:select path="obj.level" id="query_level" class="span6" >
                                            <form:option value="">--选择--</form:option>
								...
								<div class="row-fluid">
									<div class="control-group span3">
										...
										<div class="controls">
                                        <form:select path="obj.licenseType.licenseTypeId" id="query_licenseType" class="span6" >
                                            <form:option value="">--选择--</form:option>
					...
					<table id="subsidiaryRightsDataTable" class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
