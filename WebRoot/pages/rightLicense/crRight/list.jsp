				...
				<div class="row-fluid">
					...
					<div class="ace-thumbnails">
						<button class="btn btn-small btn-primary" onclick="Editorial.CrRight.edit()">
							<i class="icon-plus-sign bigger-125"></i> 新建权利授权
						</button>
					</div>
					<!-- 功能按钮结束 -->
							...
							<div class="row-fluid">
								...
								<div class="row-fluid">
									...
									<div class="control-group span4">
										<label class="control-label" for="form-field-1">权利授权名称：</label>
										<div class="controls">
									...
									<div class="control-group span4">
										...
										<div class="controls">
											<form:input path="crRight.rlicenseStarton" id="crRight_rlicenseStarton" cssClass="span10" placeholder="授权开始时间" />
										</div>
									</div>
									...
									<div class="control-group span4">
										...
										<div class="controls">
											<form:input path="crRight.rlicenseEndon" id="crRight_rlicenseEndon" cssClass="span10" placeholder="授权结束时间" />
										</div>
									</div>
