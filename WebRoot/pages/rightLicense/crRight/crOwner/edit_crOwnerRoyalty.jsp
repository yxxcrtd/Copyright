...
<body>
<input type='hidden' id='crOwnerRoyaltyDicJson' value='${dicJson}' />
			...
			<div class="row-fluid">
				...
				<div class="row-fluid">
					...
					<form:form id="crOwnerRoyaltyForm" commandName="form" class="form-horizontal">
						...
						<div class="on-down" id="on_down">
							<div class="row-fluid ">
								...
								<div class="control-group span6" id="crOwnerRoyalty_adjustRule_div">
									...
									<div class="controls">
										<form:select path="crOwnerRoyalty.adjustRule" id="crOwnerRoyalty_adjustRule" onchange="Editorial.CrOwnerRoyalty.adjustRuleToggle()" cssClass="span10">
											<form:option value="">--选择--</form:option>
								...
								<div class="control-group span6" id="crOwnerRoyalty_royaltyIndividual_div">
									...
									<div class="controls">
										<form:checkbox path="crOwnerRoyalty.royaltyIndividual" id="crOwnerRoyalty_royaltyIndividual" />
								...
								<div class="control-group span6" id="crOwnerRoyalty_reserveReturn_div">
									...
									<div class="controls">
										<form:checkbox path="crOwnerRoyalty.reserveReturn" id="crOwnerRoyalty_reserveReturn" />										
						...
						<div class="row-fluid" id="crFormulaDataTablePanel" style="display: none;">
							<!-- 功能按钮开始 -->
