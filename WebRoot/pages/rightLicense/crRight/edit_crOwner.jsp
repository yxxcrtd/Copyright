						...
						<div class="on-down" id="on_down">
							<div class="row-fluid ">
								...
								<div class="control-group span6" id="crOwner_rlProduct_rlpId_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>产品   ：</label>
									<div class="controls">
										<form:select path="crOwner.rlProduct.rlpId" id="crOwner_rlProduct_rlpId" cssClass="span6" onchange="Editorial.CrOwner.crProductSelectChange(this)" onblur="Editorial.CrOwner.validate_product();">
								...
								<div class="control-group span6" id="crOwner_corpTypeRelationship_corp_shortName_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>代理公司：</label>
									<div class="controls">
										<form:input path="crOwner.corpTypeRelationship.corp.shortName" id="crOwner_corpTypeRelationship_corp_shortName" cssClass="span6" onblur="" readonly="true" placeholder="代理公司" />
								...
								<div class="control-group span6" id="crOwner_personTrcr_id_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>贡献者：</label>
									<div class="controls">
										<form:select path="crOwner.personTrcr.id" id="crOwner_personTrcr_id" cssClass="span6" onblur="Editorial.CrOwner.validate_owner();">
											<form:option value="">--选择--</form:option>
								...
								<div class="control-group span6" id="crOwner_personTrtr_person_name_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>联系人：</label>
									<div class="controls">
										<form:input path="crOwner.personTrtr.person.name" id="crOwner_personTrtr_person_name" cssClass="span6" onblur="" readonly="true" placeholder="联系人" />
								...
								<div class="control-group span6" id="crOwner_rlperiod_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>版税报告周期：</label>
									<div class="controls">
										<form:select path="crOwner.rlperiod" id="crOwner_rlperiod" cssClass="span6" onblur="">
											<form:option value="">--选择--</form:option>
								...
								<div class="control-group span6" id="crOwner_ownerPercent_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>版税分成比率：</label>
									<div class="controls">
										<form:input path="crOwner.ownerPercent" id="crOwner_ownerPercent" cssClass="span6" onblur="Editorial.CrOwner.validate_ownerPercent()" onkeypress="onlyInputDecimalNumber(event, this)" placeholder="版税分成比率" />%
								...
								<div class="control-group span6" id="crOwner_lastedDate_div">
									...
									<div class="controls">
										<div id="crOwner_lastedDate_Date_Control" class="input-append">
											<input type="text" name="crOwner.lastedDate" value="<fmt:formatDate value="${form.crOwner.lastedDate}" pattern="yyyy-MM-dd" />" id="crOwner_lastedDate" class="span6" placeholder="上期版税结算日" data-format="yyyy-MM-dd" />
								...
								<div class="control-group span6" id="crOwner_paymentTrem_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>付款条款：</label>
									<div class="controls">
										<form:input path="crOwner.paymentTrem" id="crOwner_paymentTrem" cssClass="span6" onblur="Editorial.CrOwner.validate_paymentTrem()" onkeypress="onlyInputIntegerNumber(event, this)" placeholder="付款条款" />天
										<span id="crOwner_paymentTrem_span" class="help-inline"></span>
									</div>
								</div>
								
								<div class="control-group span6" id="crOwner_owerCopy_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>作者复本量：</label>
									<div class="controls">
										<form:input path="crOwner.owerCopy" id="crOwner_owerCopy" cssClass="span6" onblur="Editorial.CrOwner.validate_owerCopy()" onkeypress="onlyInputIntegerNumber(event, this)" placeholder="作者复本量" />本
								...
								<div class="control-group span6" id="crOwner_agentCopy_div">
									...
									<div class="controls">
										<form:input path="crOwner.agentCopy" id="crOwner_agentCopy" cssClass="span6" onblur="Editorial.CrOwner.validate_agentCopy()" onkeypress="onlyInputIntegerNumber(event, this)" placeholder="代理复本量" />本
								...
								<div class="control-group span6" id="crOwner_owerDiscount_div">
									...
									<div class="controls">
										<form:input path="crOwner.owerDiscount" id="crOwner_owerDiscount" cssClass="span6" onblur="Editorial.CrOwner.validate_owerDiscount()" onkeypress="onlyInputDecimalNumber(event, this)" placeholder="作者折扣" />%
								...
								<div class="control-group span6" id="crOwner_retainPeriod_div">
									...
									<div class="controls">
										<form:input path="crOwner.retainPeriod" id="crOwner_retainPeriod" cssClass="span6" onblur="Editorial.CrOwner.validate_retainPeriod()" onkeypress="onlyInputIntegerNumber(event, this)" placeholder="预留结算期" />期
								...
								<div class="control-group span6" id="crOwner_retainPercent_div">
									...
									<div class="controls">
										<form:input path="crOwner.retainPercent" id="crOwner_retainPercent" cssClass="span6" onblur="Editorial.CrOwner.validate_retainPercent()" onkeypress="onlyInputDecimalNumber(event, this)" placeholder="预留比率" />%
								...
								<div class="control-group span6" id="crOwner_minRetain_div">
									...
									<div class="controls">
										<form:input path="crOwner.minRetain" id="crOwner_minRetain" cssClass="span6" onblur="Editorial.CrOwner.validate_minRetain()" onkeypress="onlyInputDecimalNumber(event, this)" placeholder="最小预留" />
										<span id="crOwner_minRetain_span" class="help-inline"></span>
									</div>
								</div>
								
								<div class="control-group span6" id="crOwner_status_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>状态：</label>
									<div class="controls">
										<form:select path="crOwner.status" id="crOwner_status" cssClass="span6" onblur="">
											<form:option value="">--选择--</form:option>
										...
										<div class="row-fluid">
											...
											<div class="row-fluid">
												...
												<div class="control-group span4">
													...
													<div class="controls">
														<form:select path="crOwnerRoyalty.royaltyType" id="royaltyType" cssClass="span10">
															<form:option value="">--选择--</form:option>
												...
												<div class="control-group span4">
													...
													<div class="controls">
														<form:select path="crOwnerRoyalty.priceType" id="priceType" cssClass="span10">
															<form:option value="">--选择--</form:option>
												...
												<div class="control-group span4">
													<label class="control-label" for="form-field-1">税务信息：</label>
													<div class="controls">
														<form:select path="crOwnerRoyalty.taxDescription" id="taxDescription" cssClass="span10">
															<form:option value="">--选择--</form:option>
											...
											<div style="text-align: center;">
												<button class="btn btn-small btn-success" type="button" onclick="Editorial.CrOwner.query()">
