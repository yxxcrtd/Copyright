						...
						<div class="on-down" id="on_down">
							<div class="row-fluid ">
								...
								<div class="control-group span6" id="crProduct_firstSaleDate_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>销售开始日期：</label>
									<div class="controls">
										<div id="crProduct_firstSaleDate_Date_Control" class="input-append">
											<input type="text" name="crProduct.firstSaleDate" value="<fmt:formatDate value="${form.crProduct.firstSaleDate}" pattern="yyyy-MM-dd" />" id="crProduct_firstSaleDate" class="span10" placeholder="销售开始日期" data-format="yyyy-MM-dd" />
								...
								<div class="control-group span6" id="crProduct_coprightEndDate_div">
									...
									<div class="controls">
										<div id="crProduct_coprightEndDate_Date_Control" class="input-append">
											<input type="text" name="crProduct.coprightEndDate" value="<fmt:formatDate value="${form.crProduct.coprightEndDate}" pattern="yyyy-MM-dd" />" id="crProduct_coprightEndDate" class="span10" placeholder="版权终止日期" data-format="yyyy-MM-dd" />
											<span class="add-on"> <i data-time-icon="icon-time" data-date-icon="icon-calendar" > </i></span>
										</div>
								...
								<div class="control-group span6" id="crProduct_lastEndDate_div">
									...
									<div class="controls">
										<div id="crProduct_lastEndDate_Date_Control" class="input-append">
											<input type="text" name="crProduct.lastEndDate" value="<fmt:formatDate value="${form.crProduct.lastEndDate}" pattern="yyyy-MM-dd" />" id="crProduct_lastEndDate" class="span10" placeholder="最后版税报告日期" data-format="yyyy-MM-dd" />
											<span class="add-on"> <i data-time-icon="icon-time" data-date-icon="icon-calendar" > </i></span>
										</div>
								...
								<div class="control-group span6" id="crProduct_expiredDate_div">
									...
									<div id="crProduct_expiredDate_Date_Control" class="input-append">
											<input type="text" name="crProduct.expiredDate" value="<fmt:formatDate value="${form.crProduct.expiredDate}" pattern="yyyy-MM-dd" />" id="crProduct_expiredDate" class="span10" placeholder="产品版税过期日期" data-format="yyyy-MM-dd" />
											<span class="add-on"> <i data-time-icon="icon-time" data-date-icon="icon-calendar" > </i></span>
										</div>
								...
								<div class="control-group span6" id="crProduct_status_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>版税产品状态：</label>
									<div class="controls">
