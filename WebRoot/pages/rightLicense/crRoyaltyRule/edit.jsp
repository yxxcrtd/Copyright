						...
						<div class="on-down" id="on_down">
							<div class="row-fluid ">
								...
								<div class="control-group span6" id="crRoyaltyRule_royaltyRuleName_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>规则名称：</label>
									<div class="controls">
								...
								<div class="control-group span6" id="crRoyaltyRule_royaltyRuleCode_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>规则编号：</label>
									<div class="controls">
								...
								<div class="control-group span6" id="crRoyaltyRule_royaltyDiscount_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>版税折扣：</label>
									<div class="controls">
								...
								<div class="control-group span6" id="crRoyaltyRule_royaltyType_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>版税类型：</label>
									<div class="controls">
								...
								<div class="control-group span6" id="crRoyaltyRule_taxDescription_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>税务声明：</label>
									<div class="controls">
								...
								<div class="control-group span6" id="crRoyaltyRule_rulesState_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>规则状态：</label>
									<div class="controls">
