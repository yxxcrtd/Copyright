						...
						<div class="on-down" id="on_down">
							<div class="row-fluid ">
								...
								<div class="control-group span12" id="crLicenseType_licenseTypeCode_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>授权类型编号：</label>
									<div class="controls">
								...
								<div class="control-group span12" id="crLicenseType_licenseTypeName_div">
									<label class="control-label" for="form-field-1"><span class='red'>*</span>授权类型名称：</label>
									<div class="controls">
