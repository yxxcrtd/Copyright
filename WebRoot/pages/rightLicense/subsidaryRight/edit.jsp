				...
				<div class="row-fluid">
					...
					<div class="on-down">
                        <div class="row-fluid">
                            <div class="control-group span6">
                                <div class="control-group" id="levelDiv">
                                    ...
                                    <div class="controls">
                                        <form:select path="obj.level" id="level" class="span6" onblur="Editorial.SubsidaryRight.changeLevel();" onchange="Editorial.SubsidaryRight.levelToggle();" >
                                ...
                                <div class="control-group" id="productDiv">
                                    ...
                                    <div class="controls">
                                        <form:select path="obj.product.id" id="product" class="span6" onblur="Editorial.SubsidaryRight.changeProduct();">
                                            <form:option value="">--选择--</form:option>
                                ...
                                <div class="control-group" id="personTypeRelationshipDiv">
                                    ...
                                    <div class="controls">
                                        <form:select path="obj.personTypeRelationship.id" id="personTypeRelationship" class="span6" onblur="Editorial.SubsidaryRight.validateAuthor();">
                                            <form:option value="">--选择--</form:option>
                                            <form:options items="${form.productPersonRelationshipList}" itemValue="personTypeRelationship.id" itemLabel="personTypeRelationship.person.name" />
                                        </form:select>
                                ...
                                <div class="control-group" id="structureTypeDiv">
                                    ...
                                    <div class="controls">
                                        <form:select path="obj.structureType.id" id="structureType" class="span6" onblur="Editorial.SubsidaryRight.validateStructureType();" onchange="Editorial.SubsidaryRight.clearStructure();">
                                            <form:option value="">--选择--</form:option>
                                            <c:forEach items="${form.pstructureTypeList}" var="pst">
                                                <form:option value="${pst.id}">${pst.name}</form:option>
                                            </c:forEach>
                                        </form:select>
                                ...
                                <div class="control-group" id="statusDiv">
                                    ...
                                    <div class="controls">
                                        <form:select path="obj.status" id="status" class="span6" onblur="Editorial.SubsidaryRight.validateStatus();">
                                            <form:option value="">--选择--</form:option>
                            ...
                            <div class="control-group span6">
                                <div class="control-group" id="licenseTypeDiv">
                                    ...
                                    <div class="controls">
                                        <form:select path="obj.licenseType.licenseTypeId" id="licenseType" class="span6" onblur="Editorial.SubsidaryRight.validateLicenseType();">
                                            <form:option value="">--选择--</form:option>
                                ...
                                <div class="control-group" id="royaltyRuleDiv">
                                    ...
                                    <div class="controls">
                                        <form:select path="obj.royaltyRule" id="royaltyRule" onblur="Editorial.SubsidaryRight.validateRoyaltyRule();" onchange="Editorial.SubsidaryRight.royaltyRuleToggle()" class="span6">
                                            <form:option value="">--选择--</form:option>
                                ...
                                <div class="control-group" id="adjustRuleDiv">
                                    ...
                                    <div class="controls">
                                        <form:select path="obj.adjustRule" id="adjustRule" onblur="Editorial.SubsidaryRight.validateAdjustRule();" onchange="Editorial.SubsidaryRight.adjustRuleToggle()" class="span6">
                                            <form:option value="">--选择--</form:option>
						...
						<ul class="nav nav-tabs">
				            <li id="authorizedAreaLi" class="active"><a href="#authorizedArea" onclick="Editorial.SubsidaryRight.initAuthorizedAreaDataTable()" data-toggle="tab">授权地域</a></li>
				            <li id="authorizationLanguageLi"><a href="#authorizationLanguage" onclick="Editorial.SubsidaryRight.initAuthorizationLanguageDataTable()" data-toggle="tab">授权语种</a></li>
				            <li id="calculationRulesLi"><a href="#calculationRules" onclick="Editorial.SubsidaryRight.initCrFormulaDataTable()" data-toggle="tab">计算规则</a></li>
				        </ul>
				        <!-- TAB页 结束 -->
				        <!-- TAB页 内容 开始 -->
