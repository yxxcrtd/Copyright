...
function addObj() {
	...
	if (selectNode) {
		...
		var url = $('#ctx').val() + "/pages/base/country/form/editRegion?fatherId=" + fatherID + "&countryId=" + $("#id").val();
		var commonModalCss = {
			"width" : "450px",
			"height" : "300px"
		};
...
function editObj() {
	...
	if (BMEP.Base.Country.Show.zTree.getSelectedNodes()[0]) {
		var selectNode = BMEP.Base.Country.Show.zTree.getSelectedNodes()[0];
		var url = $('#ctx').val() + "/pages/base/country/form/editRegion?eid=" + selectNode.id+"&countryId=" +$("#id").val();
		var commonModalCss = {
				"width" : "450px",
				"height" : "300px"
		};
