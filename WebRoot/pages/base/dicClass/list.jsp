				...
				<div class="row-fluid">
					...
					<div class="ace-thumbnails">
						<button class="btn btn-small btn-primary" onclick="BMEP.DicClass.addObj();">
							<i class="icon-plus-sign bigger-125"></i> 新建数据字典分类
						</button>
					</div>
					<!---------------功能按钮部分开始 --------------------->
					<!-- ------------------查询开始----------------------------- -->
                    ...
                    <div class="on-down">
						<form:form id="form" commandName="form"
							class="form-horizontal">
								...
								<div class="row-fluid">
									...
									<div class="control-group span3">
										<label class="control-label" for="form-field-1">数据字典分类名称：</label>
										<div class="controls">
								...
								<div class="row-fluid">
									<div class="control-group span3">
										<label class="control-label" for="form-field-2">国际化参数值：</label>
										<div class="controls">
