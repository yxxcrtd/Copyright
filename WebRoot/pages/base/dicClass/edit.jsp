				...
				<div class="row-fluid">
					...
					<div class="on-down">
						<div class="control-group" id="codeDiv">
							<label class="control-label" for="form-field-1"><span class='red'>*</span>数据字典编号：</label>
							<div class="controls">
								<form:input path="obj.code" id="code" placeholder="数据字典分类编码" onblur="BMEP.DicClass.code();" class="span6" />
								<span id="codeSpan" class="help-inline"></span>
							</div>
						</div>
						<div class="control-group" id="nameDiv">
							<label class="control-label" for="form-field-1"><span class='red'>*</span>数据字典名称：</label>
							<div class="controls">
								<form:input path="obj.name" id="name" placeholder="数据字典分类名称" 
						...
						<div class="control-group" id="internationCodeDiv">
							<label class="control-label" for="form-field-1"><span class='red'>*</span>国际化参数值：</label>
							<div class="controls">
