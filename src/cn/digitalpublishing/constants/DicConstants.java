...
public class DicConstants {
    ...
    /**
     * webgate账户状态（1-在用 2-停用）
     */
    public static final int WEBGATE_ACCOUNT_STATUS_USING = 1;
    public static final int WEBGATE_ACCOUNT_STATUS_USELESS = 2;
    ...
    public static final String CODE_TYPE_WAREHOUSE = "15"; // 仓库编号
    public static final String CODE_TYPE_WAREHOUSEFLOOR = "16"; // 仓库层编号
    public static final String CODE_TYPE_WAREHOUSEROOM = "17"; // 仓库房间编号
    public static final String CODE_TYPE_SHELF = "18"; // 货架编号
    public static final String CODE_TYPE_FLOOR = "19"; // 货架层编号
    public static final String CODE_TYPE_LOCATION = "20"; // 货位编号
	 ...
	 * 版税结算状态
	 */
	public static final String CR_SETTLEMENT_TYPE = "CrSettlementType";
	public static final String CR_SETTLEMENT_TYPE_1 = "1"; // 未结算
	public static final String CR_SETTLEMENT_TYPE_2 = "2"; // 已结算
}
