...
public class BCountryDao extends CommonDao<BCountry, String> {

	

	public List<BCountry> getList(Map<String, Object> condition, String sort,HqlBean hqlBean) throws Exception {
	...
	public List<BCountry> getPagingList(Map<String, Object> condition, String sort, Integer pageCount, Integer page,HqlBean hqlBean) throws Exception {
	...
	public Integer getCount(Map<String, Object> condition, String sort,HqlBean hqlBean) throws Exception {
		...
		return list == null ? 0 : Integer.parseInt(list.get(0).getId());
	}
