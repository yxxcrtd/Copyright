...
public class PProductPersonRelationshipDao extends CommonDao<PProductPersonRelationship, String> {

	public List<PProductPersonRelationship> getPagingList(
		...
		try {
			...
			List<PProductPersonRelationship> list = hibernateDao.getListByHql(
	...
	public List<PProductPersonRelationship> getList(
