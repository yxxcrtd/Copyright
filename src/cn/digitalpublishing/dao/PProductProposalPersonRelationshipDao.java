...
import cn.digitalpublishing.po.PProductProposalPersonRelationship;

public class PProductProposalPersonRelationshipDao extends CommonDao<PProductProposalPersonRelationship, String> {

	public List<PProductProposalPersonRelationship> getPagingList(
		...
		try {
			...
			List<PProductProposalPersonRelationship> list = hibernateDao.getListByHql(
	...
	public List<PProductProposalPersonRelationship> getList(
