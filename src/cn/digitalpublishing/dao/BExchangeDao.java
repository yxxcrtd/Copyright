...
public class BExchangeDao extends CommonDao<BExchange, String> {

	public List<BExchange> getList(Map<String, Object> condition, String sort,HqlBean hqlBean) throws Exception {
	...
	public List<BExchange> getPagingList(Map<String, Object> condition, String sort, Integer pageCount, Integer page,HqlBean hqlBean) throws Exception {
		List<BExchange> list = null;
		try {
			DaoHelper helper = new DaoHelper();
			String where = (helper.getWhere(hqlBean.getConditions(), condition) != null && "".equals(helper.getWhere(hqlBean.getConditions(), condition))) ? helper.getWhere(hqlBean.getConditions(), condition) : " where "+helper.getWhere(hqlBean.getConditions(), condition);
	...
	public Integer getCount(Map<String, Object> condition, String sort,HqlBean hqlBean) throws Exception {
		...
		return list == null ? 0 : Integer.parseInt(list.get(0).getExId());
	}
