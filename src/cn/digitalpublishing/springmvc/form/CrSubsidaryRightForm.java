...
public class CrSubsidaryRightForm extends DataTableForm<CrSubsidaryRight> {
	...
	private List<PStructureType> pstructureTypeList = new ArrayList<PStructureType>();
	...
	public List<PProductPersonRelationship> getProductPersonRelationshipList() {
		return productPersonRelationshipList;
	}

	public void setProductPersonRelationshipList(
			List<PProductPersonRelationship> productPersonRelationshipList) {
		this.productPersonRelationshipList = productPersonRelationshipList;
	}
...
//	}
//
//	public void setProductStructureRelationshipList(
//			List<PProductStructureRelationship> productStructureRelationshipList) {
...
//	}
	...
	public List<PStructureType> getPstructureTypeList() {
		return pstructureTypeList;
	}

	public void setPstructureTypeList(List<PStructureType> pstructureTypeList) {
		this.pstructureTypeList = pstructureTypeList;
	}
