...
public class BDicController extends BaseController {
	...
	public BDicForm manager(BDicForm form) throws Exception
	{
		...
		try {
			...
			if(!Strings.isNullOrEmpty(request.getParameter("dicIdInCrRight"))) {
				condition.put("dicIdInCrRight", request.getParameter("dicIdInCrRight"));
			}
			if(!Strings.isNullOrEmpty(request.getParameter("dicIdSubsidaryRight"))) {
				condition.put("dicIdSubsidaryRight", request.getParameter("dicIdSubsidaryRight"));
			}
