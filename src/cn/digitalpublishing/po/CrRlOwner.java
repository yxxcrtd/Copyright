...
public class CrRlOwner implements Serializable {
	...
	private CrmCorpTypeRelationship corpTypeRelationship; // 代理公司
	private CrmPersonTypeRelationship personTrtr; // 联系人
	private CrmPersonTypeRelationship personTrcr; // 贡献者
	@JsonIgnore
	...
	public CrmPersonTypeRelationship getPersonTrtr() {
		return personTrtr;
	}

	public void setPersonTrtr(CrmPersonTypeRelationship personTrtr) {
		this.personTrtr = personTrtr;
	}

	public CrmPersonTypeRelationship getPersonTrcr() {
		return personTrcr;
	}

	public void setPersonTrcr(CrmPersonTypeRelationship personTrcr) {
		this.personTrcr = personTrcr;
	}
