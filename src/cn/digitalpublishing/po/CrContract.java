...
public class CrContract implements Serializable {
	...
	public Set<PProductContractRelationship> getProductContractRelationshipSet() {
		return productContractRelationshipSet;
	}

	public void setProductContractRelationshipSet(Set<PProductContractRelationship> productContractRelationshipSet) {
		this.productContractRelationshipSet = productContractRelationshipSet;
	}
}