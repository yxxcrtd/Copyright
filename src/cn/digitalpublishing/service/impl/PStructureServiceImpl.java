...
public class PStructureServiceImpl extends BaseServiceImpl implements PStructureService {
	...
	@Override
    public List<PProductStructureRelationship> getDistinctStructureTypeList(Map<String, Object> condition, String sort) throws Exception {
        HqlBean hqlBean = HqlBeanCacheUtil.gethqlBeanCache().get("cn.digitalpublishing.dao.PProductStructureRelationshipDao").get("getDistinctStructureTypeList");
        List<PProductStructureRelationship> list = this.daoFacade.getProductStructureRelationshipDao().getDistinctStructureTypeList(condition, "", hqlBean);
        return list;
    }
